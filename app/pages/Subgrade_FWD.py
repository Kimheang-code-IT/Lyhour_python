"""Subgrade Design > FWD/BB (sidebar page)."""
...
from app.pages.Subgrade_Design.fwd import FwdPage
from app.widgets.button import secondary_button
from app.widgets.scroll_utils import fit_scroll_content


@define_page("blank", title="FWD/BB")
class SubgradeFwdPage(BasePage):
    """FWD/BB analysis page (placeholder content)."""
    ...
    def setup(self, content: QVBoxLayout) -> None:
        ...
        self._page_title = QLabel("FWD/BB")
        ...
        content.addWidget(self.fwd_page, 1)
