...
a = Analysis(
    ...
    hiddenimports=[
        ...
        'app.chart',
        'app.chart.dcp',
        'app.chart.cbr_equivalent',
        'app.chart.superelevation',
        'app.chart.pavement_catalog',
        'app.chart.cross_section',
        'app.chart.vertical_curve',
        'app.data.pavement_catalog',
        'app.data.cross_section',
        'app.data.vertical_curve',
        'app.data.mpwt_thickness',
        'app.data.mpwt_rigid',
        'app.data.aashto_rigid',
        'app.pages.Flexible_Pavement.mpwt',
        'app.pages.Rigid_Pavement',
        'app.pages.Rigid_Pavement.page',
        'app.pages.Rigid_Pavement.mpwt',
        'app.pages.Rigid_Pavement.aashto',
        'xlrd',
    ],
    hookspath=[],
    hooksconfig={},
